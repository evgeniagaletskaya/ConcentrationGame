...
class ViewController: UIViewController {
    ...
    private let sportsTheme = Theme(backgroundColor: #colorLiteral(red: 0.7813243667, green: 0.1662555156, blue: 0.07822589874, alpha: 1), cardsColor: #colorLiteral(red: 1, green: 0.9046518281, blue: 0.6567809878, alpha: 1), cardsTitles: ["⚽️","🏀","🏓","🥊","⛷","🏊‍♂️","🚴‍♀️","🏒","🎱"], themeName: "Sports")
